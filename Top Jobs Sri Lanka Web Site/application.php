<?php 
	...
	if(isset($_POST['btn2'])){
		...
		$sql = "INSERT INTO application (Name with Initials,Full Name,Address,DOB,Gender,Contact No,Status,Email,CV File) VALUES ('$name','$fname','$address','$dob','$gender','$contact','$status','$email','$file')";
...
<body>
	...
	<div>
		<h1 class = "header2">Submit your Application</h1>
		<form action = "application.php" method = "POST" class = "bkground_application">
			<table border = "0" class = "form2">
				<tr>
					<th colspan = "2" style = "	font-size:22px;" align = "center">PERSONAL INFO</th>
				</tr>
				<tr>
				...
				<tr>
					<td colspan = "2"><input type = "submit" value = "Submit" name = "btnsubmitapp" class = "btnsubmitapp" /></td>
				</tr>
			</table>
		</form>
	</div>
