<?php		
		...
		echo "<html>
				...
				<body>
					...
					<div class = 'bkground_jobs'>

					<form action = 'search.php' method = 'POST' class = 'search-center top'>
						<input type = 'text' name = 'search' class = 'inp1' placeholder = 'Search Here' />
						<input type = 'submit' class = 'subbtn' value = 'Search' />
					</form>
					
			<div class = 'table-wrapper'>
				<table border = '0' width = '1200px' style = 'background-color:MintCream; margin-left:125px; border-radius: 8px; margin-bottom: 40px;'>";
